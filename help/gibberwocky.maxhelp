...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 89.428574, 191.0, 24.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 27.0, 191.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 161.0, 274.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 76.0, 280.5, 90.5, 25.0 ],
					"style" : "",
					"text" : "start audio"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 27.0, 266.0, 45.0, 45.0 ],
					"style" : ""
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 68.0, 166.0, 61.0, 22.0 ],
									"presentation_rect" : [ 49.0, 134.0, 0.0, 0.0 ],
									"style" : "",
									"text" : "amp 0.25"
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 70.0, 28.0, 0.0, 0.0 ],
									"style" : ""
								}
...
,
									"patching_rect" : [ 239.0, 247.0, 216.0, 23.0 ],
									"presentation_rect" : [ 333.0, 239.0, 0.0, 0.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 172.0, 113.0, 50.0, 22.0 ],
									"presentation_rect" : [ 171.0, 133.0, 0.0, 0.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 172.0, 78.0, 41.0, 22.0 ],
									"presentation_rect" : [ 172.0, 99.0, 0.0, 0.0 ],
									"style" : "",
									"text" : "/ 127."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 124.0, 113.0, 50.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 124.0, 78.0, 41.0, 22.0 ],
									"style" : "",
									"text" : "/ 127."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 20.0, 131.0, 61.0, 22.0 ],
									"style" : "",
									"text" : "amp 0.25"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 436.0, 26.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 370.333344, 26.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 304.666656, 26.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 172.0, 26.0, 30.0, 30.0 ],
									"style" : ""
								}
...
,
									"patching_rect" : [ 20.0, 247.0, 202.0, 23.0 ],
									"style" : "",
									"text" : "gen~ @title fmsynth"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 436.0, 320.0, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 27.0, 226.0, 456.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 27.0, 156.5, 93.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 27.0, 24.0, 183.0, 27.0 ],
					"style" : "",
					"text" : "gibberwocky.max"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 151.857147, 156.5, 58.142853, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 477.5, 159.5, 53.0, 39.0 ],
					"range" : [ 0.0, 1.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 415.5, 159.5, 53.0, 39.0 ],
					"range" : [ 0.0, 1.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 353.5, 159.5, 53.0, 39.0 ],
					"range" : [ 0.0, 1.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 291.5, 159.5, 53.0, 39.0 ],
					"range" : [ 0.0, 1.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 335.5, 58.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 242.0, 65.0, 111.0, 25.0 ],
					"style" : "",
					"text" : "open editor"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 161.0, 574.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 76.0, 580.5, 90.5, 25.0 ],
					"style" : "",
					"text" : "start audio"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 216.0, 65.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 27.0, 566.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal", "", "" ],
					"patching_rect" : [ 27.0, 336.0, 467.0, 196.0 ],
					...
					"snapshot" : 					{
						...
						"snapshot" : 						{
							...
							"valuedictionary" : 							{
								"parameter_values" : 								{
									"ad-level" : 0.0,
									"clhat-decay" : 477.346558,
									"hat-level" : 61.077377,
									"hat-tone" : 7.828157,
									"kick-attack" : 1.173087,
									"kick-decay" : 2999.307373,
									"kick-level" : 32.262962,
									"kick-sweep" : 5.496141,
									"kick-tune" : 105.292908,
									"ophat-decay" : 2425.670166,
									"snare-decay" : 9.496189,
									"snare-hicut" : 1306.771606,
									"snare-level" : 31.677727,
									"snare-snap" : 27.991875,
									"snare-tune" : 500.0,
									"tom-decay" : 3000.0,
									"tom-hi" : 200.0,
									"tom-level" : 0.307908,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 194.0, 580.5, 160.0, 30.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 214.285721, 156.5, 58.142853, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_linknames" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 216.0, 101.0, 267.0, 29.0 ],
					"style" : "",
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 225.5, 147.0, 36.5, 147.0 ],
					"source" : [ "obj-1", 0 ]
				}
